...
import sys
sys.path.insert(0, r'D:\AI_test\shared\tools')
from excel_styles import to_openpyxl_styles
import os
from datetime import datetime

# === Load data ===
conn = sqlite3.connect(r'D:\AI_test\projects\ecr-ecn\workspace\db\ecr_ecn.db')
cursor = conn.cursor()
...
wb_src = openpyxl.load_workbook(
    r'D:\AI_test\projects\ecr-ecn\vault\originals\20260203 Phenitec背金轉背錫 晶片+產品 list.xlsx',
...
# === Save ===
output_path = r'D:\AI_test\projects\ecr-ecn\vault\outputs\跨變更交叉分析報告.xlsx'
